    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "12px", width: "100%" }}>
      ...
      >
        <input
          ...
          style={{ display: "none" }}
          id="bir-certification-file-input"
        ...
        {hasImage ? (
          ...
          >
            ...
            <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: "4px" }}>
              <p style={{ fontSize: "18px", fontWeight: 600, color: "var(--p-navy)", margin: 0, wordBreak: "break-all" }}>
                {selectedFile ? selectedFile.name : (isPdfFile ? "Current Certificate (PDF)" : "Current Certificate Image")}
              </p>
              {selectedFile && (
          ...
          <div className="bir-upload-card">
            {/* Left Section */}
            <div className="bir-upload-left">
              {/* Cloud Icon */}
              <div 
                style={{ 
                  width: "64px", 
              ...
              {/* Upload Texts */}
              <div className="bir-upload-text-container" style={{ display: "flex", flexDirection: "column", gap: "4px", textAlign: "left" }}>
