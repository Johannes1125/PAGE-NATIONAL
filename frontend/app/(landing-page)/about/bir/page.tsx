...
export default function BirCertificationPage() {
  ...
  return (
    <div className="bir-main" style={{ fontFamily: "'Poppins', sans-serif" }}>
      {/* Hero Section */}
      <section className="cbl-hero" style={{ background: "linear-gradient(135deg, #051026 0%, #081734 60%, #112347 100%)", padding: "130px 0 70px", color: "#ffffff", borderBottom: "1px solid rgba(255, 255, 255, 0.1)" }}>
        <div className="container">
          <div className="cbl-breadcrumb" style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "28px" }}>
            ...
            <span style={{ color: "rgba(255, 255, 255, 0.35)", fontSize: "13px" }}>/</span>
            <span style={{ color: "#ffffff", fontSize: "13px", fontWeight: 600 }}>BIR Certification</span>
          </div>
          ...
          <div style={{ maxWidth: "720px" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", fontSize: "11px", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "#ffffff", background: "rgba(255, 255, 255, 0.08)", border: "1px solid rgba(255, 255, 255, 0.15)", padding: "6px 16px", borderRadius: "20px", marginBottom: "20px" }}>
              ...
              <span>TAX COMPLIANCE • BIR</span>
            </div>
            <h1 style={{ fontSize: "clamp(38px, 4.5vw, 54px)", fontWeight: 800, color: "#ffffff", lineHeight: 1.15, letterSpacing: "-0.8px", marginBottom: "18px" }}>BIR Certification</h1>
          ...
          <div className="sec-content-grid">
            ...
            <div className="sec-card sec-card--details">
              <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "28px", paddingBottom: "20px", borderBottom: "1px solid #e2e8f0" }}>
                ...
                <div>
                  <h2 style={{ fontSize: "20px", fontWeight: 800, color: "#081734", margin: 0 }}>Tax Exemption Status</h2>
                  <span style={{ color: "#059669", fontSize: "13px", fontWeight: 600, display: "inline-flex", alignItems: "center", gap: "6px", marginTop: "4px" }}>
                    <CheckCircle size={15} /> BIR Accredited & Compliant
                  </span>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                <div>
                  ...
                  <p style={{ margin: "4px 0 0", fontSize: "16px", fontWeight: 700, color: "#081734" }}>{displayDetails.registeredName}</p>
                </div>
                <div>
                  <span style={{ fontSize: "11px", fontWeight: 700, color: "#718096", textTransform: "uppercase", letterSpacing: "1px" }}>TIN Number</span>
              ...
              <div className="sec-cert-box" style={{
                ...
                {activeRecord && activeRecord.imageUrl ? (
                  ...
                  <>
                    ...
                    <h3 style={{ fontSize: "13px", textTransform: "uppercase", letterSpacing: "1.5px", margin: "0 0 4px", fontWeight: 700, color: "#081734" }}>Bureau of Internal Revenue</h3>
                    <h4 style={{ fontSize: "11px", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 16px", color: "#4a5568" }}>Republic of the Philippines</h4>
                    
                    <div style={{ height: "1px", width: "60%", background: "#e2e8f0", marginBottom: "20px" }} />
                    
                    <h2 style={{ fontSize: "17px", fontWeight: 800, color: "#081734", margin: "0 0 10px" }}>CERTIFICATE OF TAX EXEMPTION</h2>
                    <p style={{ fontSize: "12px", lineHeight: 1.6, color: "#4a5568", margin: "0 0 20px" }}>
                      Official BIR accreditation and tax-exempt certification issued to PAGE National.
                    </p>

                    <div style={{ marginTop: "auto", width: "100%" }}>
                      <p style={{ fontSize: "11px", fontWeight: 700, color: "#081734", margin: 0 }}>BIR Compliant Association</p>
                    </div>
                  </>
                )}
              </div>
                    ...
                    {birRecords.filter(r => r.imageUrl).map((record) => (
                      ...
                      >
                        ...
                        <span style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1 }}>
                          {record.registrationName || "BIR Certificate Document"}
                        </span>
                      </a>
                    ))}
                  </div>
